...
class BannerView: UIView
{
    ...
    func createBanner(imagesArray:[UIImage])
    {
        ...
        timer = Timer.scheduledTimer(timeInterval: 3, target: self, selector: #selector(self.actionAutoSlide), userInfo: nil, repeats: true)
    }
    ...
    func bannerView()
    {
        ...
        self.aspectHeight = self.aspectWidth*0.48
        self.dragging = false
        self.moving = false
