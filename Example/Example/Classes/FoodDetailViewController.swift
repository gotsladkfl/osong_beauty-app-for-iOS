...
class FoodDetailViewController: ElongationDetailViewController,MTMapViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        tableView.registerNib(FoodGridViewCell.self)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeue(FoodGridViewCell.self)
