...
class HotelDetailViewController: ElongationDetailViewController,MTMapViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        tableView.registerNib(HotelGridViewCell.self)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeue(HotelGridViewCell.self)
